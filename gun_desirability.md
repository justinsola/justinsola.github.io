...
For the [hunting rifle prompt](./files/hunting_rifle.png) I use 75% of screen width. For the [AR-15 prompt](./files/ar-15.png) I use 70% width, with 40% for the [pistol prompt](./files/pistol.png). Here is a [zip file](./files/gun_desirability_prompts.zip) containing all three prompt images.
